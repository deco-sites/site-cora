      ...
      >
        ...
        >
          <div
            ...
            className={"text-base-100 text-[2rem] pr-8 sm:text-[2.629rem] leading-8 sm:mb-6 lg:mb-0 xl:text-[3.4rem] xl:leading-[3.6rem] 2xl:pr-20 lg:pr-8"}
          >
          </div>
        </div>
        <div
          className={"py-[1.9rem] lg:col-start-6 lg:col-end-[-2] 2xl:py-7 2xl:px-12"}
        >
          <ul
            className={"grid grid-cols-1 grid-rows-auto sm:grid-cols-2 sm:grid-rows-2 gap-6 justify-between"}
          >
            {ItenList.map((iten) => {
              return (
