...
export default function Header({ logo, itensMenu, login, register }: Props) {
  return (
    <header
      className={"fixed top-0 left-0 w-full h-[64px] xl:h-[88px] bg-base-100 z-50"}
    >
      <div
        className={"w-full px-6 xl:px-16 flex flex-row justify-between xl:justify-around items-center h-full"}
      >
        <div>
          <a href={logo.href}>
        ...
        <ul
          className={"hidden xl:flex xl:flex-row xl:justify-center xl:items-center xl:gap-5"}
        >
        ...
        <div className={"flex-row flex justify-center items-center gap-6"}>
