...
export default function Article(
  ...
  return (
    ...
    >
      <div
        className={`py-14 xl:px-16 flex flex-col max-w-[1700px] m-auto px-6 items-center ${
      ...
      >
        ...
        <div className={"flex flex-col md:w-2/4 lg:w-2/5"}>
          ...
          <div>
            <a
              href={link.href}
              className={"text-primary font-bold group flex flex-row gap-2 items-center md:text-lg xl:text-[1.5rem]"}
            >
              {link.label}
              <span
