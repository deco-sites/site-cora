...
export default function Article(
  ...
  return (
    <div
      className={`py-14 flex flex-col sm:flex-row ${
        index == 0 && "bg-base-500"
      } ${index == 1 && "bg-base-400"} ${index == 2 && "bg-base-300"} ${
        index == 3 && "bg-base-content"
    ...
    >
      ...
      <div className={"flex flex-col md:w-2/4"}>
        <div>
          <h4
            className={"mb-6 font-bold text-[1.5rem] text-secondary xl:text-5xl"}
          >
            {title}
          </h4>
          <div
            className={"text-secondary mb-7 xl:text-2xl"}
        ...
        <div>
          <a
            href={link.href}
            className={"text-primary font-bold group flex flex-row gap-2 items-center md:text-lg xl:text-2xl"}
          >
            {link.label}
            <span
              className={"group-hover:translate-x-2 duration-200 ease-in-out xl:w-9"}
            >
              <svg
